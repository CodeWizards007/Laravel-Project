    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-xs-5">
                        <h2>Gesion <b>Blog</b></h2>
                    </div>
                    <div class="col-xs-7">
                        <a href="{{ url('/blogs/create') }}" class="btn btn-primary"><i class="material-icons">&#xE147;</i> <span>Ajouter un nouveau Blog</span></a>
                        <a href="#" class="btn btn-primary"><i class="material-icons">&#xE24D;</i> <span>PDF</span></a>						
                    </div>
                </div>
            </div>
...
                                            <form method="POST" action="{{ url('/blogs' . '/' . $item->id) }}" accept-charset="UTF-8">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
