...
                                        <td>
                                            <a href="{{ url('/evenements/' . $item->id . '/edit') }}" title="Edit Evenements"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Modifier</button></a>
                                            <form method="POST" action="{{ url('/evenements' . '/' . $item->id) }}" accept-charset="UTF-8">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
